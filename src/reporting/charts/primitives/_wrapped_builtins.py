...
def plot_bar(  # noqa: WPS211
    ...
    return _build_figure(
        ...
        graph_object_producer_kwargs=dict(orientation=orientation, barmode=barmode),
        data=data,
        x=x,
        y=y,
        color=color,
...
def plot_histogram(  # noqa: WPS211
    ...
    return _build_figure(
        ...
        graph_object_producer_kwargs=dict(
            histnorm=histnorm, nbins=nbins, barmode=barmode,
        ),
        data=data,
        x=x,
        y=y,
...
def plot_scatter(  # noqa: WPS211
    ...
    return _build_figure(
        ...
        graph_object_producer_kwargs=dict(trendline=trendline),
        data=data,
        x=x,
        y=y,
        color=color,
