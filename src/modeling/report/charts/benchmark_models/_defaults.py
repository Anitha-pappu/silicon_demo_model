...
from ._autoregressive import AutoregressiveBenchmarkModel  # noqa: WPS436
from ._benchmark_model_base import BenchmarkModelBase  # noqa: WPS436
from ._moving_average import MovingAverageBenchmarkModel  # noqa: WPS436


def fit_default_benchmark_models(
    target: str, data: pd.DataFrame, timestamp: str,
) -> dict[str, BenchmarkModelBase]:
