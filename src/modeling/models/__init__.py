...
from ..utils import create_mock_class_to_raise_import_error
from ._cross_validation import cross_validate
...
try:
    from .sklearn_model.gam import SklearnCompatibleLinearGAM
except ImportError:
    SklearnCompatibleLinearGAM = (  # type: ignore  # noqa: WPS440
        create_mock_class_to_raise_import_error(  # type: ignore
            missing_libs="pygam",
        )
    )
