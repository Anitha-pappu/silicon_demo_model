...
def load_transformer(  # noqa: WPS210,WPS231
    ...
    if isinstance(transformer_config, tuple):
        unsupported_type = (
            ...
            and getattr(transformer_config[1], "fit", None) is None  # type: ignore
        )
        if unsupported_type:
    ...
    step_name: str = transformer_config.get("name", "transformer_step")
    ...
    if wrapping_strategy is None:
        return step_name, tp.cast(Transformer, sklearn_transformer)
