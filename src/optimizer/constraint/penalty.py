...
from optimizer.types import Matrix, ReducesMatrixToSeries, Vector

from . import penalties

_TPenaltyFunction = tp.Union[str, ReducesMatrixToSeries, float]
...
class Penalty(BaseHandler):
    ...
    def __init__(
        ...
        penalty_function: _TPenaltyFunction = "linear",
        ...
        Args:
            ...
            penalty_function: how to calculate the penalty from the constraint value.
                              ...
                              the same shape.
                              - float: constant penalty for violating the constraint.
            penalty_multiplier: float, constant to multiply the penalty.
        ...
        elif isinstance(penalty_function, (float, int)):
    ...
    def __call__(self, parameters: Matrix, **kwargs: tp.Any) -> Vector:
        ...
        self.calculated_penalty = self.calculated_penalty.astype(float)
...
def penalty(
    *constraint_definition: TConstrainDefinition,
    ...
    Constructs a penalty function for a single sided constraint.
    ...
    Args:
        ...
        penalty_function: typing.Union[str, Callable, float], how to calculate
    ...
    Raises:
        InvalidConstraintError: for incorrect constraint_definition.
            See ``optimizer.constraint.constraint`` for more details.
...
class _ScoreFunctionWrapper:
    ...
    def __init__(
        self,
        score_func: tp.Callable[[tp.Any], tp.Any],
        pipeline: Pipeline
    ) -> None:
...
def history_penalty(
    ...
    penalty_multiplier: float = 1.0,
    pipeline: tp.Optional[Pipeline] = None,
    name: tp.Optional[str] = None,
    score_func: tp.Optional[ReducesMatrixToSeries] = None,
) -> Penalty:
    ...
    Args:
        ...
        penalty_multiplier: float, the value by which the anomaly score is multiplied
