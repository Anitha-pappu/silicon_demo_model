...
class RandomSearchSolver(ScaledContinuousSolver):
    ...
    def __init__(
        ...
        init: tp.Union[str, Matrix] = "random",
        ...
        self._global_best_idx: tp.Optional[int] = None
        self._objective_values: tp.Optional[int] = None
        self._best_objective_values: tp.Optional[int] = None
    ...
    def _sample_from_epsilon_hypercube(self) -> Matrix:
        ...
        if self._epsilon < self._min_epsilon:  # pylint: disable=R1731
