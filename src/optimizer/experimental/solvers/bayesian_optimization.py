...
class BayesianOptSolver(ContinuousSolver):
    ...
    def __init__(
        ...
        gpr_kwargs: tp.Optional[tp.Dict[str, tp.Any]] = None,
        acq_func: str = "ucb",
    ) -> None:
    ...
    def _acq_func_opt(self, n_restarts: int = 25) -> Vector:
    ...
    def _internal_objective_values(self) -> Vector:
        ...
        Returns:
            Vector of current objective values.
        """
        return self._objective_values


def ucb(  # pylint: disable=unused-argument
    x_test: Vector,
    gp_model: tp.Any,
    X_s: Vector,
    Y_s: Vector,
...
def expected_improvement(  # pylint: disable=unused-argument
    x_test: Vector,
    gp_model: tp.Any,
    X_s: Vector,
    Y_s: Vector,
