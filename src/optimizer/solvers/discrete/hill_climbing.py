...
class HillClimbingSolver(IndexedDiscreteSolver):
    ...
    def _reset_solutions(self, boolean_index_vector: Vector) -> None:
    ...
    def _reset_current_moves(self, boolean_index_vector: Vector) -> None:
    ...
    def _reset_exploration_indices(self, boolean_index_vector: Vector) -> None:
    ...
    def _inc_dec_zero_move(self, current_neighbor: Vector) -> Vector:
    ...
    def _transition_current_move(self) -> None:
    ...
    def _update_current_solutions_and_objective(self, objective_values: Vector) -> None:
    ...
    def _update_best_solutions_and_objective(self) -> None:
    ...
    def _incorporate_results_for_current_move(self, objective_values: Vector) -> None:
    ...
    def best(self) -> tp.Tuple[Vector, float]:
        ...
        Returns:
            Tuple, (Vector, float), the best solution and its objective value.
        """
