...
from optimizer.types import MINIMIZE, Matrix, TSense, Vector
...
class CrossoverStrategy(abc.ABC):
    ...
    def __init__(
        ...
        seed: tp.Optional[tp.Union[np.random.RandomState, int]] = None,
    ):
        """Constructor.
    ...
    @abc.abstractmethod
    def crossover(
        self, parent_population_a: Vector, parent_population_b: Vector,
    ) -> Vector:
    ...
    @classmethod
    def from_string(cls, strategy: str, **kwargs: tp.Any) -> "CrossoverStrategy":
...
class SelectionStrategy(abc.ABC):
    ...
    def __init__(self, seed: tp.Optional[tp.Union[np.random.RandomState, int]] = None):
        """Constructor.
    ...
    @abc.abstractmethod
    def select(
        self, population: Vector, fitnesses: Vector, n_selected: tp.Optional[int] = None
    ) -> Vector:
    ...
    @classmethod
    def from_string(cls, strategy: str, **kwargs: tp.Any) -> "SelectionStrategy":
...
class GeneticAlgorithmSolver(MixedDomainSolver):
    ...
    def __init__(
        ...
        selection_strategy: tp.Union[str, SelectionStrategy] = "tournament",
        crossover_strategy: tp.Union[str, CrossoverStrategy] = "one-point",
        mutation_rate: float = 0.2,
        selection_kwargs: tp.Optional[tp.Dict[str, tp.Any]] = None,
        crossover_kwargs: tp.Optional[tp.Dict[str, tp.Any]] = None,
    ):
        """Constructor.
        ...
        self._objective_values: tp.Optional[Vector] = None

        # pylint: enable=too-many-arguments

    def mutate(self, population: Vector) -> Vector:
