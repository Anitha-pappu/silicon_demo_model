...
from optimizer.types import MINIMIZE, TBounds, TSense, Vector

TDomain = tp.Sequence[tp.Union[TBounds, RealDimension]]


def to_limits(domain: TDomain) -> Vector:
...
class ContinuousSolver(Solver, ABC):
...
class ScaledContinuousSolver(ContinuousSolver, ABC):
    # pylint: disable=abstract-method
    """
    ...
    def __init__(
        ...
        """
        self.limits: Vector
        self._scale_mean: Vector
        self._scale_range_multiplier: Vector
        self._scale_range_divisor: Vector
    ...
    def _init_population_array(self, parameters: Vector) -> Vector:
    ...
    def _inverse_transform_parameters(self, parameters: Vector) -> Vector:
    ...
    def _transform_parameters(self, parameters: Vector) -> Vector:
    ...
    @staticmethod
    def _clip(parameters: Vector) -> Vector:
    ...
    def _set_domain_and_scale(self, value: TDomain) -> None:
