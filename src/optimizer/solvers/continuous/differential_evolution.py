...
from optimizer.solvers.continuous.base import (
    ContinuousSolver,
    TBounds,
    TDomain,
)
...
class _DifferentialEvolutionWrapper(_DifferentialEvolutionSolver):
    ...
    def __init__(
        ...
        maxiter: int = 1000,
        mutation: tp.Union[TBounds, float] = (0.5, 1.0),
        ...
        """
        self.population: Vector
        self.population_energies: Vector
        self.scale = None
    ...
    def update(self, trial_population: Vector, trial_fitnesses: Vector) -> None:
    ...
    def set_bounds(self, bounds: tp.List[tp.Tuple[float]]) -> None:
...
class DifferentialEvolutionSolver(ContinuousSolver):
