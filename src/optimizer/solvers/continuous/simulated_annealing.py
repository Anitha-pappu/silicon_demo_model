...
class SimulatedAnnealingSolver(ScaledContinuousSolver):  # pylint: disable=too-many-instance-attributes  # noqa: E501
    """
    Simulated Annealing.
    ...
    def _generate_point(self) -> Vector:
        ...
        point[self.current_dimension] += r * self.step_vector[  # type: ignore
