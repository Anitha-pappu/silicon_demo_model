...
class EvolutionaryStrategiesSolver(ScaledContinuousSolver):  # pylint: disable=too-many-instance-attributes  # noqa: E501
    """
    ...
    def __init__(
        ...
        initial_mean: tp.Optional[Vector] = None,
        mu: tp.Optional[int] = None,
        lam: tp.Optional[int] = None,
        maxiter: int = 1000,
        sigma: float = 0.3,
    ):
        """Constructor.
        ...
        self.niters = 1
        self.nevals = 0
        self.eigen_update: float = 0
        self.best_sample: Vector
        self.best_objective: tp.Optional[float] = None
        self.elites: Vector
        self.elites_objectives: tp.Optional[Vector] = None
        self.current_samples: tp.Optional[Vector] = None
    ...
    def update_eigen_decomposition(self) -> None:
    ...
    def best(self) -> tp.Tuple[Vector, float]:
        ...
        return (
            ...
            tp.cast(float, self.best_objective)
            if self.sense == MINIMIZE
            else -1 * tp.cast(float, self.best_objective),
        )
