...
def _bfs(key: str, edges: tp.Dict[str, tp.Set[str]]) -> tp.Set[str]:
...
class DependencyGraph(object):
    ...
    def __init__(self) -> None:
        """ New DependencyGraph """
        self.dependencies: tp.Dict[str, tp.Set[str]] = {}
        self.dependents: tp.Dict[str, tp.Set[str]] = {}

    def add_dependency(self, tag: str, depends_on: str) -> None:
        """
    ...
    def remove_dependency(self, tag: str, depends_on: str) -> None:
        """
    ...
    def get_dependents(self, tag: str) -> tp.Set[str]:  # noqa: WPS615
        """
    ...
    def get_dependencies(self, tag: str) -> tp.Set[str]:  # noqa: WPS615
        """
